...
px.import({
 sceneEventEmitter: 'utils:sceneEventEmitter.js',
  ...
  function Scrollable(scene, parent, args) {
    ...
    this.initialRowScrollHeight = style.rowScrollHeight;
    ...
    if (this.args.rowScrollHeight) {
      style.rowScrollHeight = this.args.rowScrollHeight
      this.initialRowScrollHeight = this.args.rowScrollHeight
    }
  ...
  Scrollable.prototype.setRowScrollHeight = function (rowScrollHeight) {
    style.rowScrollHeight = rowScrollHeight
  }
  Scrollable.prototype.updateSize = function (changeW, changeH) {
    style.rowScrollHeight = this.initialRowScrollHeight * changeH
    this.update();
  }
  ...
  Scrollable.prototype.update = function()
  {
    ...
    if (scrollDiff)
    {
      ...
      * this.container.h / this.content.h;
      ...
      this.setRowScrollHeight(this.scrollbarHandle.h * 0.64)
  ...
  this.content.animateTo({  y: posY }, 0.3,
